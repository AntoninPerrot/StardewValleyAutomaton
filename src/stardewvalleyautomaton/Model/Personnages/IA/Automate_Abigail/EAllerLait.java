...
import static stardewvalleyautomaton.Model.Personnages.IA.Automate_Abigail.Enum_EtatAbi.EAllerLait;
 ...
 * @author perro
 */
public class EAllerLait extends EtatAbi{
    ...
    public EtatAbi getEtatSuivant(IA_Abigail abi) {
        ...
        if(abi.getFatiguePrevision()>=100){
            ...
            if(abi.getListeActions().isEmpty()){
                res = new ETraire();
        }
